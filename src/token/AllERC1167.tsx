...
import { useERC1167Count, useERC1167List } from "../useErigonHooks";
...
const AllERC1167: FC = () => {
  ...
  const total = useERC1167Count(provider);
  const results = useERC1167List(provider, pageNumber, PAGE_SIZE, total);
